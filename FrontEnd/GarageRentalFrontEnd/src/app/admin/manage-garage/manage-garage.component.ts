...
export class ManageGarageComponent implements OnInit {
  ...
  updateForm: FormGroup = new FormGroup({
    ...
    availablE_FROM: new FormControl('', [Validators.required,Validators.min(1),Validators.max(23)]),
    availablE_TO: new FormControl('',[ Validators.required,Validators.max(24),Validators.min(1)]),
